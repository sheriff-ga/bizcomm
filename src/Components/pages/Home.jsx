    ...
    <div className={`landing ${isNavOpen ? 'is-nav-open' : ''}`}>
      ...
      <section id="banner">
        ...
        <ul className="actions">
          <li><a href="#contact" className="button big special">Contact Us</a></li>
        </ul>
      </section>
      ...
      <section id="one" className="wrapper style1">
        <div className="inner">
          ...
          <article className="feature right">
            <span className="image"><img src={img2} alt="image 2" width="600" height="463" /></span>
            <div className="content">
              <h2>Our Founder</h2>
      ...
      <section id="two" className="wrapper special">
        <div className="inner">
          ...
          {/* <div className="image-grid"> */}
            ...
            <div>
            <a href="/bizcomm/services" style={{color: "#1d2227", textDecoration: "none"}}>1. Networking and Structure Cabling Solutions</a> <br /> <br />
            <a href="/bizcomm/services" style={{color: "#1d2227", textDecoration: "none"}}>2. Desktop PC Hardware and Software Support:</a> <br /> <br />
            <a href="/bizcomm/services" style={{color: "#1d2227", textDecoration: "none"}}>3. Computer Systems and Accessories:</a> <br /> <br />
            <a href="/bizcomm/services" style={{color: "#1d2227", textDecoration: "none"}}>4. Database Management Systems</a> <br /> <br />
            <a href="/bizcomm/services" style={{color: "#1d2227", textDecoration: "none"}}>5. Web Design, Maintenance, and Hosting</a> <br /> <br />
            {/* <a href="/bizcomm/services" className="image"><img src={img1} alt="" width="299" height="200" /></a> <br />
            <a href="/bizcomm/services" className="image"><img src={img1} alt="" width="299" height="200" /></a>
            <a href="/bizcomm/services" className="image"><img src={img1} alt="" width="299" height="200" /></a> */}
          </div>
          <br /> <br />
          <ul className="actions">
      ...
      {/* Four */}
      <section id="contact" className="wrapper style2 special">
        <div className="inner">
          <header className="major narrow">
            <h2>Get in touch</h2>
          ...
          {/* <form action="#" > */}
            ...
            <ul className="actions">
              <li><a href="mailto:azeezjeleeladebayo@gmail.com"><input type="submit" className="special" value="Send a mail!" href=""/></a></li>
      ...
      <footer id="footer">
        <div className="inner">
          <ul className="icons">
            <li><a onClick={handleClick} className="icon fa-facebook"><span className="label">Facebook</span></a></li>
            <li><a onClick={handleClick} className="icon fa-twitter"><span className="label">Twitter</span></a></li>
            <li><a onClick={handleClick} className="icon fa-instagram"><span className="label">Instagram</span></a></li>
            <li><a onClick={handleClick} className="icon fa-linkedin"><span className="label">LinkedIn</span></a></li>
          </ul>
        </div>
      </footer>
    </div>
